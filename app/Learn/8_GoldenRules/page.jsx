...
export default function learn() {
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <h2 className="text-4xl font-semibold mb-10 mt-20">8 Golden Rules</h2>
      
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-300">
        <h3 className="text-3xl font-semibold mb-2">Eight Golden Rules ของ Shneiderman’s จะช่วยทำให้การออกแบบอินเทอร์เฟซได้ดียิ่งขึ้น </h3>
        ...
        <p className="text-gray-600 mb-4 ml-4" >ปฏิบัติตาม "กฎทอง 8 ประการในการออกแบบอินเทอร์เฟซ" ของ Ben Shneiderman หากคุณต้องการออกแบบอินเทอร์เฟซผู้ใช้ที่ยอดเยี่ยม มีประสิทธิภาพ และไม่สร้างความหงุดหงิด Apple, Google และ Microsoft เป็นเพียงบางส่วนของบริษัทที่ประสบความสำเร็จอย่างสูงซึ่งผลิตภัณฑ์ที่ได้รับการออกแบบอย่างดีของพวกเขาสะท้อนถึงกฎของ Shneiderman</p>
        <div className="flex justify-center">
        
        </div>

          <h3 className="text-2xl font-semibold mb-2 mt-6">เอาละมาดูกันว่า<span className="text-yellow-500"> กฎทอง ทั้ง 8 ข้อ</span> มีเนื้อหาอะไรบ้าง ? </h3>
          
          <ul class="list-disc p-5 " > <span className="font-semibold  text-yellow-500 ">1. มุ่งมั่นเพื่อความสม่ำเสมอ (Strive for Consistency): </span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">2. รองรับการควบคุมของผู้ใช้ (Enable Frequent Users to Use Shortcuts): </span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">3. แจ้งผลลัพธ์ที่ชัดเจนแก่ผู้ใช้ (Offer Informative Feedback): </span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">4. ออกแบบให้การทำงานเป็นไปทีละขั้นตอน (Design Dialogs to Yield Closure):</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">5. เสนอการจัดการข้อผิดพลาดอย่างง่าย (Offer simple error handling. ):</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">6. อนุญาตให้ผู้ใช้แก้ไขข้อผิดพลาดได้ง่าย (Permit Easy Reversal of Actions):</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">7. ควบคุมความสามารถของผู้ใช้ให้เหมาะสม (Support Internal Locus of Control):</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-yellow-500">ลดความจำของผู้ใช้ (Reduce Short-Term Memory Load):</span> 
