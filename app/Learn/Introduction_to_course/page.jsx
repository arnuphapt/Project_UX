...
export default function learn() {
  return (
    <div className="max-w-7xl mx-auto p-4 bg-white shadow-md rounded-lg p-6 border border-gray-300 mt-10">
      ...
      <h2 className="ml-4 mb-8 mt-20">อย่างแรกเรามาทำความเข้าใจเบื้องต้นเกี่ยวกับบทนำ โดยการรับชมวิดิโอ User experience (Ux) Intro Course กันก่อนดีกว่า  </h2>
      <iframe 
    ...
    allowFullScreen>
        ...
        <h2 className="ml-4 mb-8 mt-20">หากอยากรู้จักอาชีพที่เกี่ยวกับ User experience (Ux) /User Interface (UI) สามารถเข้ารับชมเพิ่มเติมได้ที่   </h2>
        <iframe 
    className="w-full max-w-2xl h-96 mt-10 mb-10 m-auto" 
    ...
    allowFullScreen>
        ...
        <h2 className=" text-l  mb-4 ml-5 ">เนื่องจากมนุษย์ทุกคนต่างมีความรู้สึกที่ตอบสนองต่อการใช้งานบางอย่าง ไม่ว่าจะเป็นผลิตภัณฑ์หรือแพลตฟอร์มเว็บไซต์ต่าง ๆ ตัวอย่างเช่น โกรธ, สนุกสนาน, มีความสุข, เครียด, พึงพอใจ เป็นต้น ซึ่งความรู้สึกเหล่านี้มักเกิดขึ้นหลังจากการใช้งานบางอย่างเสมอ  </h2>
        <h2 className="ml-4 mb-8 font-bold mt-20">ในLecture บทที่1 บทนำนี้ จะแบ่งออกเป็น 2 เรื่อง ได้แก่ 1. People in User experience (UX)และ 2.How to Create UX Personas </h2>
...
<li className="mb-2 ml-6 mt-4 text-blue-500 font-semibold"> <a href=" https://www.youtube.com/playlist?list=PLiwVA5qjDkicrRkWfrKcDiktwiizwTG7c" target="_blank">People in UX (VDO Paylist - รวม 20 นาที)</a></li>
          <li className="mb-2 ml-6 text-blue-500 font-semibold"> <a href="https://www.youtube.com/playlist?list=PLiwVA5qjDkiddFIFN5chvhtFcLYAKsMlg" target="_blank">Persona (Clip VDO - 2 clips รวม 12 นาที)</a></li>
