...
<div className="2xl:hidden fixed bottom-10 left-1/2 transform -translate-x-1/2 z-50">
    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <h2 className="text-2xl font-bold mb-4 m-6 text-center text-blue-600">2. Heuristic Evaluation.</h2>
      <p className="text-gray-700 mb-12 mt-10 text-center">Heuristic Evaluation คือ วิธีการทดสอบความสามารถในการใช้งาน (Usability) ของผลิตภัณฑ์หรือระบบ เช่น เว็บไซต์หรือแอปพลิเคชัน โดยใช้หลักการหรือเกณฑ์ที่เรียกว่า 
        ...
        <img src="/Heuristic.png" alt="Heuristic" className=" h-auto w-full max-w-3xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300  " />

          <h3 className="text-xl font-semibold mb-2 mt-20 ml-6">เรามาทำความเข้าใจทั้ง 10 ข้อ ของการเลือก Heuristic Evaluation กันดีกว่า  </h3>
          
          <h3 className="text-xl font-semibold mb-2 mt-6 ml-10">" 10 Usability Heuristics "  </h3>
          <img src="https://uxbooth.com/wp-content/uploads/2022/01/2-Usability-Heuristics.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-3xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300  " />
        
          <ul className="list-disc p-5 ml-6 "> <span className="font-semibold  text-black ml-5 "> 1. Visibility of System Status (การแสดงสถานะของระบบ) :</span> 
          ...
          <img src="https://miro.medium.com/v2/resize:fit:1400/1*9GoBnizSi9xm639q6u7dyA.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
         
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 2. Match Between System and the Real World (ความสอดคล้องระหว่างระบบกับโลกจริง) :</span> 
          ...
          <img src="https://miro.medium.com/v2/resize:fit:2000/1*2pDIt7Zzy3aC7JKniO-L7w.jpeg" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
         
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 3. User Control and Freedom (การควบคุมและเสรีภาพของผู้ใช้) :</span> 
          ...
          <img src="https://miro.medium.com/v2/resize:fit:1400/1*8GAA-397nmGfHAbRaZCNbQ.jpeg" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
         
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 4. Consistency and Standards (ความสอดคล้องและมาตรฐาน) :</span> 
          ...
          <img src="https://forum.sublimetext.com/uploads/default/original/3X/c/1/c18bf142469bdaad18a2b1a96a6dff71888b346d.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
          
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 5. Error Prevention (การป้องกันข้อผิดพลาด) :</span> 
          ...
          <img src="/error.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
          
         
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 6. Recognition Rather Than Recall (การจดจำแทนการจำ) :</span> 
          ...
          <img src="https://blog.logrocket.com/wp-content/uploads/2023/08/search-results-example.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
          
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 7. Flexibility and Efficiency of Use (ความยืดหยุ่นและประสิทธิภาพในการใช้งาน) :</span> 
          ...
          <img src="/flexibility.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
          
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 8. Aesthetic and Minimalist Design (การออกแบบที่สวยงามและเรียบง่าย) :</span> 
          ...
          <img src="https://media.nngroup.com/media/editor/2020/12/23/screenshot-www16personalitiescom-20201124-18_53_57.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
          
          
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 9. Help Users Recognize, Diagnose, and Recover from Errors (ช่วยให้ผู้ใช้รู้จัก วินิจฉัย และฟื้นฟูจากข้อผิดพลาด) :</span> 
          ...
          <img src="https://webkul.design//wp-content/uploads/2021/12/help-users-recognize-diagnose-recover-from-errors-2-1024x656.png" alt="10 Usability Heuristics" className=" h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
         
         
          <ul className="list-disc p-5 ml-6"> <span className="font-semibold  text-black ml-5"> 10. Help and Documentation (การช่วยเหลือและเอกสาร) :</span> 
          ...
          <img src="https://media.nngroup.com/media/editor/2020/11/12/oreilly.png" alt="10 Usability Heuristics" className="h-auto w-full max-w-2xl mx-auto p-7  mb-6 mt-10 rounded-xl shadow-xl transform hover:scale-105 transition-all duration-300 " />
          </ul>
...
<li className="mb-2 ml-6 mt-4 text-blue-500 font-semibold"> <a href=" https://docs.google.com/presentation/d/1kd2VrADeO2lo-F6RgXFBEl9LzQ1wXO7n/edit#slide=id.p1" target="_blank">สไลด์เนื้อหาเพิ่มเติม</a></li>
          <li className="mb-2 ml-6 text-blue-500 font-semibold"> <a href="https://drive.google.com/file/d/0B3vZXgaQ6559Zl8wOHhPWXdHU0U/view?resourcekey=0-UnTBolLA9wQW6WBzZRSyIQ" target="_blank" rel="noreferrer">Heuristic Evaluation Report</a></li>
