...
<div className="flex">
      ...
      <div className="w-64 bg-gray-100 h-auto p-4 border-r border-gray-300">
        ...
        <ul className="space-y-4">
          ...
          <li>
            ...
            className="block px-4 py-2 rounded-lg bg-grey-500 hover:bg-blue-500 hover:text-white transition-colors "
    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <h3 className="text-2xl font-semibold mb-2 mt-8">Value Proposition Canvas</h3>
        ...
        <ul class="list-disc p-5"> <span className="font-semibold  text-black ml-5">1. ลูกค้าคือใคร เช่น ประกอบอาชีพอะไร :</span> 
          <li className="mb-2 text-gray-600 ml-20"> การระบุว่าลูกค้าคือใครสำคัญมาก เพราะจะช่วยให้คุณเข้าใจพฤติกรรม ความต้องการ และลักษณะเฉพาะของพวกเขา</li>
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">ตัวอย่าง :</span> 
          <ul class="list-none">
          ...
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">คุณต้องเข้าใจ Pain Points หรือปัญหาที่ลูกค้ากำลังเผชิญ เช่น</span> 
          <ul class="list-none">
          ...
          <li className="mb-2 text-black-600 ml-20 font-semibold"> ยิ่งเข้าใจปัญหาของลูกค้าอย่างชัดเจน คุณจะสามารถออกแบบสินค้า/บริการเพื่อช่วยพวกเขาได้ดียิ่งขึ้น</li>
          </ul>

          <ul class="list-disc p-5"> <span className="font-semibold  text-black ml-5">3. ลูกค้าอยากได้อะไรเพิ่มเติมในชีวิตบ้าง :</span> 
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">ส่วนนี้คือการระบุ Gains หรือสิ่งที่ลูกค้าต้องการเพิ่มเติม เช่น</span> 
          <ul class="list-none">
          ...
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">ตัวอย่าง :</span> </li>
          ...
          <li className="mb-2 text-gray-600 ml-20"> ต้องกำหนดว่า Value Proposition หรือคุณค่าที่สินค้าของคุณนำเสนอคืออะไร</li>
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">ตัวอย่าง :</span> 
          <ul class="list-none">
          ...
          <li className="mb-2 text-gray-600 ml-20"> สินค้าหรือบริการของคุณต้องตอบโจทย์ Pain Points ที่ลูกค้ามี</li>
          <li className="mb-2 text-gray-600 ml-20"><span className="font-semibold  text-black ">ตัวอย่าง :</span> 
          <ul class="list-none">
