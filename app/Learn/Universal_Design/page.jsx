...
export default function learn() {
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <h2 className="text-4xl font-semibold mb-4 mt-20">Universal Design -The Principles-</h2>
      
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-300">
        <h3 className="text-xl font-semibold mb-2">Universal Design คือ "การออกแบบและจัดวางสิ่งแวดล้อมเพื่อให้ทุกคนสามารถเข้าถึง เข้าใจ และใช้งานได้ในระดับสูงสุดเท่าที่จะเป็นไปได้ โดยไม่คำนึงถึงอายุ ขนาด หรือความพิการ " อ้างอิงจากพระราชบัญญัติความพิการของไอร์แลนด์ ปี 2005  </h3>
        <img src="/Universal_banner.png" alt="Universal_banner" className=" h-auto w-full max-w-3xl mx-auto p-7  mb-6 mt-10 " />

          <h3 className="text-2xl font-semibold mb-2 mt-6">Universal Design -The Principles- มีทั้งหมด 7หัวข้อ ได้แก่ </h3>
          <img src="/Principles_universal.png" alt="Principles_universal" className=" h-auto w-full max-w-4xl mx-auto p-7  mb-6 mt-10 " />
        
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 "> 1. Equitable Use (การใช้งานอย่างเสมอภาค) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 2. Flexibility in Use (ความยืดหยุ่นในการใช้งาน) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 3. Simple and Intuitive Use (ใช้งานง่าย ไม่ซับซ้อน) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 4. Perceptible Information (ข้อมูลเข้าใจง่าย แม้สำหรับผู้มีข้อจำกัดในการรับรู้) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 5. Low Physical Effort (ใช้แรงกายในการใช้งานน้อย) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 6. Tolerance for Error (ออกแบบที่ยอมรับความผิดพลาด ลดโอกาสเกิดความผิดพลาดร้ายแรง) :</span> 
          ...
          <ul class="list-disc p-5 ml-5"> <span className="font-semibold  text-black ml-5"> 7. Size and Space for Approach and Use (ขนาดและพื้นที่ที่เหมาะสมสำหรับการใช้งานโดยกลุ่มคนต่างๆ) :</span> 
          ...
          <h3 className="text-2xl font-semibold mb-2 mt-6">"User-Centred Design" (การออกแบบที่ยึดผู้ใช้เป็นศูนย์กลาง) </h3>
          <h3 className="text-xl font-semibold mb-2 ml-6">เน้นไปที่แนวคิดต่าง ๆ ในการออกแบบเพื่อให้ครอบคลุมและเข้าถึงกลุ่มคนหลากหลายลักษณะ ซึ่งรวมถึง: </h3>
         
         
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">1. Inclusive Design (การออกแบบที่ครอบคลุม) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">2. Design for All (การออกแบบเพื่อทุกคน) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">3. User Needs Design (การออกแบบตามความต้องการของผู้ใช้) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">4. User-Centred Design (การออกแบบที่ยึดผู้ใช้เป็นศูนย์กลาง) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">5. Human-Centred Design (การออกแบบที่ยึดมนุษย์เป็นศูนย์กลาง) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">6. Barrier-Free Design (การออกแบบที่ไม่มีสิ่งกีดขวาง) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">7. Accessible Design (การออกแบบที่เข้าถึงได้) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">8. Adaptable Design (การออกแบบที่ปรับเปลี่ยนได้) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">9. Transgenerational Design (การออกแบบสำหรับหลายช่วงวัย) :</span> 
          ...
          <ul class="list-disc p-5 ml-5 "> <span className="font-semibold  text-black ml-5 ">10. Design for a Broader Average (การออกแบบที่เหมาะสมกับคนส่วนใหญ่) :</span> 
