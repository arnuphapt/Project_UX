...
export default function learn() {
  return (
    <div className="max-w-7xl mx-auto p-4">
      ...
      <h2 className="text-4xl font-semibold mb-4 mt-20">7 principles</h2>
      <p className="text-gray-700 mb-12">เรียนรู้หลักการทั้งเจ็ดที่ช่วยทำให้เว็บไซต์ของคุณมีความน่าสนใจมากขึ้นโดย ดร. ซูซาน ไวน์เชงค์:</p>
      <div className="bg-white shadow-md rounded-lg p-6 border border-gray-300">
        ...
        allowFullScreen>
          ...
          <h3 className="text-2xl font-semibold ml-4 mt-20">7 หลักการทำให้เว็บไซต์ของคุณน่าสนใจยิ่งขึ้น: </h3>
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">ทางเลือกมากเกินไป? (Too Many Choices?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">การยืนยันทางสังคม? (Social Validation?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">สร้างความรู้สึกเร่งด่วน? (Scarcity?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">อาหาร, เซ็กส์ หรืออันตราย? (Food, Sex or Danger?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">สิ่งนำสายตา (Power of Faces?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">เล่าเรื่องที่ดึงดูดใจ? (Story?) :</span> 
          ...
          <ul class="list-disc p-5"> <span className="font-semibold  text-gray-600">ความมุ่งมั่น? (Commitment?) :</span> 
